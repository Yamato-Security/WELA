...
function Add-Rule {
    ...
    $detectRule = {
        function Search-DetectableEvents {
            ...
            $result = $event |  where {($_.ID -eq "7045" -and $_.message -match "ServiceName.*NtsSrv" -and $_.Service File Name -eq "* LocalService") } | select TimeCreated,Id,RecordId,ProcessId,MachineName,Message;
